...
try {
    ...
    $posts = [
        ...
        ['coordinate17.png', 'ロンドンらしい個性的なストリートコーデ', 'ストリート', 'イギリス', 'ロンドン'],
        ['coordinate18.png', 'チェック柄を使った日常コーデ', 'カジュアル', 'イギリス', 'マンチェスター'],
        ['coordinate19.png', 'シンプルで存在感のあるモードスタイル', 'モード', 'イギリス', 'ロンドン'],
        ['coordinate20.png', '英国らしいクラシックな古着コーデ', '古着', 'イギリス', 'リバプール'],
    ];
